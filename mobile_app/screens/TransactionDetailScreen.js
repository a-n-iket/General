...
const tran = {
  ...
  transactionAmt: "50",
  transactionDesc:
    "Juice dsfae sdfeie s f gd sesaaef efefes asdf f gd sesaaef efefes asdf ",
  time: "10:11:50",
            ...
            <View style={{ justifyContent: "space-around" }}>
              <Text
                style={{
                  ...
                  alignSelf: "center",
                  color:
                    tran.addedBy == myid && tran.transactionAmt >= 0
                      ? "green"
                      : "red",
                }}
              >
                {Math.abs(tran.transactionAmt)}
              </Text>
              <Text style={{ color: "grey", fontWeight: "400", fontSize: 13 }}>
                {tran.addedBy == myid && tran.transactionAmt >= 0
                  ? "YOU GAVE"
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("addtransaction", {
                  yougave: true,
                  isEdit: true,
                  amt: tran.transactionAmt,
                  des: tran.transactionDesc,
                })
              }
              style={{
